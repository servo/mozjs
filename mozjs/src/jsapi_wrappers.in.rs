...
wrap!(jsapi: pub fn GetRequestedModuleSourcePos(cx: *mut JSContext, moduleRecord: HandleObject, index: u32, lineNumber: *mut u32, columnNumber: *mut ColumnNumberOneOrigin));
...
wrap!(jsapi: pub fn StartCollectingDelazifications1(cx: *mut JSContext, module: HandleObject, stencil: *mut Stencil, alreadyStarted: *mut bool) -> bool);
...
wrap!(jsapi: pub fn FinishCollectingDelazifications1(cx: *mut JSContext, module: HandleObject, buffer: *mut TranscodeBuffer) -> bool);
