...
wrap!(jsapi: pub fn NewFunctionByIdWithReservedAndProto(cx: *mut JSContext, native: JSNative, proto: HandleObject, nargs: ::std::os::raw::c_uint, flags: ::std::os::raw::c_uint, id: jsid) -> *mut JSFunction);
...
wrap!(jsapi: pub fn LoadRequestedModules(cx: *mut JSContext, module: HandleObject, hostDefined: Handle<Value>, resolved: LoadModuleResolvedCallback, rejected: LoadModuleRejectedCallback) -> bool);
wrap!(jsapi: pub fn LoadRequestedModules1(cx: *mut JSContext, module: HandleObject, hostDefined: Handle<Value>, promiseOut: MutableHandleObject) -> bool);
wrap!(jsapi: pub fn FinishLoadingImportedModule(cx: *mut JSContext, referrer: Handle<*mut JSScript>, moduleRequest: HandleObject, payload: Handle<Value>, result: HandleObject, usePromise: bool) -> bool);
...
wrap!(jsapi: pub fn FinishLoadingDynamicImportedModule(cx: *mut JSContext, referrer: Handle<*mut JSScript>, moduleRequest: HandleObject, payload: Handle<Value>, result: HandleObject) -> bool);
...
wrap!(jsapi: pub fn GetRequestedModuleType(cx: *mut JSContext, moduleRecord: HandleObject, index: u32) -> ModuleType);
...
wrap!(jsapi: pub fn GetModuleRequestType(cx: *mut JSContext, moduleRequestArg: HandleObject) -> ModuleType);
wrap!(jsapi: pub fn ModuleRequestIsSourcePhase(cx: *mut JSContext, moduleRequestArg: HandleObject) -> bool);
...
wrap!(jsapi: pub fn GetSavedFrameColumn(cx: *mut JSContext, principals: *mut JSPrincipals, savedFrame: HandleObject, columnp: *mut TaggedColumnNumberOneOrigin, selfHosted: SavedFrameSelfHosted) -> SavedFrameResult);
...
wrap!(jsapi: pub fn StartCollectingDelazifications(cx: *mut JSContext, script: Handle<*mut JSScript>, stencil: *mut Stencil, result: *mut CollectDelazificationsResult) -> bool);
wrap!(jsapi: pub fn StartCollectingDelazifications1(cx: *mut JSContext, module: HandleObject, stencil: *mut Stencil, result: *mut CollectDelazificationsResult) -> bool);
...
wrap!(jsapi: pub fn JS_ErrorFromException(cx: *mut JSContext, obj: HandleObject, errorReport: *mut BorrowedErrorReport) -> bool);
...
wrap!(jsapi: pub fn JS_DeletePropertyById1(cx: *mut JSContext, obj: HandleObject, id: Handle<jsid>) -> bool);
...
wrap!(jsapi: pub fn JS_NewFloat16ArrayFromArray(cx: *mut JSContext, array: HandleObject) -> *mut JSObject);
wrap!(jsapi: pub fn JS_NewFloat16ArrayWithBuffer(cx: *mut JSContext, arrayBuffer: HandleObject, byteOffset: usize, length: i64) -> *mut JSObject);
