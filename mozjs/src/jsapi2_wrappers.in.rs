wrap!(jsapi: pub fn ReportOutOfMemory(cx: &mut JSContext));
wrap!(jsapi: pub fn ReportLargeOutOfMemory(cx: &mut JSContext));
wrap!(jsapi: pub fn SetContextProfilingStack(cx: &mut JSContext, profilingStack: *mut ProfilingStack));
wrap!(jsapi: pub fn EnableContextProfilingStack(cx: &mut JSContext, enabled: bool));
...
wrap!(jsapi: pub fn SetStackFormat(cx: &mut JSContext, format: StackFormat));
wrap!(jsapi: pub fn GetStackFormat(cx: &mut JSContext) -> StackFormat);
...
wrap!(jsapi: pub fn NukeRemovedCrossCompartmentWrapper(cx: &mut JSContext, wrapper: *mut JSObject));
...
wrap!(jsapi: pub fn NukeCrossCompartmentWrapper(cx: &mut JSContext, wrapper: *mut JSObject));
wrap!(jsapi: pub fn NukeCrossCompartmentWrapperIfExists(cx: &mut JSContext, source: *mut Compartment, target: *mut JSObject));
...
wrap!(jsapi: pub fn SetWindowProxyClass(cx: &mut JSContext, clasp: *const JSClass));
wrap!(jsapi: pub fn SetWindowProxy(cx: &mut JSContext, global: Handle<*mut JSObject>, windowProxy: Handle<*mut JSObject>));
wrap!(jsapi: pub fn IsArgumentsObject(obj: HandleObject) -> bool);
wrap!(jsapi: pub fn AddRawValueRoot(cx: &mut JSContext, vp: *mut Value, name: *const ::std::os::raw::c_char) -> bool);
wrap!(jsapi: pub fn RemoveRawValueRoot(cx: &mut JSContext, vp: *mut Value));
wrap!(jsapi: pub fn UseInternalJobQueues(cx: &mut JSContext) -> bool);
wrap!(jsapi: pub fn EnqueueJob(cx: &mut JSContext, job: HandleObject) -> bool);
wrap!(jsapi: pub fn StopDrainingJobQueue(cx: &mut JSContext));
wrap!(jsapi: pub fn RestartDrainingJobQueue(cx: &mut JSContext));
wrap!(jsapi: pub fn RunJobs(cx: &mut JSContext));
wrap!(jsapi: pub fn ShouldIgnorePropertyDefinition(cx: &mut JSContext, key: JSProtoKey, id: jsid) -> bool);
wrap!(jsapi: pub fn AssertSameCompartment(cx: &mut JSContext, obj: *mut JSObject));
...
wrap!(jsapi: pub fn NewFunctionByIdWithReserved(cx: &mut JSContext, native: JSNative, nargs: ::std::os::raw::c_uint, flags: ::std::os::raw::c_uint, id: jsid) -> *mut JSFunction);
wrap!(jsapi: pub fn NewFunctionByIdWithReservedAndProto(cx: &mut JSContext, native: JSNative, proto: Handle<*mut JSObject>, nargs: ::std::os::raw::c_uint, flags: ::std::os::raw::c_uint, id: jsid) -> *mut JSFunction);
...
wrap!(jsapi: pub fn SetPreserveWrapperCallbacks(cx: &mut JSContext, preserveWrapper: PreserveWrapperCallback, hasReleasedWrapper: HasReleasedWrapperCallback));
wrap!(jsapi: pub fn IsObjectInContextCompartment(obj: *mut JSObject, cx: &JSContext) -> bool);
wrap!(jsapi: pub fn SetDOMCallbacks(cx: &mut JSContext, callbacks: *const DOMCallbacks));
wrap!(jsapi: pub fn GetDOMCallbacks(cx: &mut JSContext) -> *const DOMCallbacks);
wrap!(jsapi: pub fn GetTestingFunctions(cx: &mut JSContext) -> *mut JSObject);
wrap!(jsapi: pub fn GetErrorTypeName(cx: &mut JSContext, exnType: i16) -> *mut JSLinearString);
wrap!(jsapi: pub fn NukeCrossCompartmentWrappers(cx: &mut JSContext, sourceFilter: *const CompartmentFilter, target: *mut Realm, nukeReferencesToWindow: NukeReferencesToWindow, nukeReferencesFromTarget: NukeReferencesFromTarget) -> bool);
...
wrap!(jsapi: pub fn SetScriptEnvironmentPreparer(cx: &mut JSContext, preparer: *mut ScriptEnvironmentPreparer));
wrap!(jsapi: pub fn SetAllocationMetadataBuilder(cx: &mut JSContext, callback: *const AllocationMetadataBuilder));
...
wrap!(jsapi: pub fn GetGCHeapUsage(cx: &mut JSContext) -> u64);
...
wrap!(jsapi: pub fn StringToLinearStringSlow(cx: &mut JSContext, str_: *mut JSString) -> *mut JSLinearString);
...
wrap!(jsapi: pub fn IsIncrementalBarrierNeeded(cx: &mut JSContext) -> bool);
wrap!(jsapi: pub fn GetCurrentRealmOrNull(cx: &mut JSContext) -> *mut Realm);
wrap!(jsapi: pub fn SetDestroyRealmCallback(cx: &mut JSContext, callback: DestroyRealmCallback));
wrap!(jsapi: pub fn SetRealmNameCallback(cx: &mut JSContext, callback: RealmNameCallback));
...
wrap!(jsapi: pub fn GetRealmObjectPrototype(cx: &mut JSContext) -> *mut JSObject);
wrap!(jsapi: pub fn GetRealmFunctionPrototype(cx: &mut JSContext) -> *mut JSObject);
...
wrap!(jsapi: pub fn EnterRealm(cx: &mut JSContext, target: *mut JSObject) -> *mut Realm);
wrap!(jsapi: pub fn LeaveRealm(cx: &mut JSContext, oldRealm: *mut Realm));
wrap!(jsapi: pub fn ResetRealmMathRandomSeed(cx: &mut JSContext));
...
wrap!(jsapi: pub fn LossyTwoByteCharsToNewLatin1CharsZ(cx: &mut JSContext, tbchars: *const Range<u16>) -> Latin1CharsZ);
...
wrap!(jsapi: pub fn LossyUTF8CharsToNewTwoByteCharsZ(cx: &mut JSContext, utf8: *const UTF8Chars, outlen: *mut usize, destArenaId: arena_id_t) -> TwoByteCharsZ);
...
wrap!(jsapi: pub fn EncodeUtf8ToWide(cx: &mut JSContext, chars: *const ::std::os::raw::c_char) -> UniqueWideChars);
wrap!(jsapi: pub fn GetWellKnownSymbolKey(cx: &mut JSContext, which: SymbolCode) -> PropertyKey);
...
wrap!(jsapi: pub fn SetHostEnsureCanAddPrivateElementHook(cx: &mut JSContext, op: EnsureCanAddPrivateElementOp));
wrap!(jsapi: pub fn SetBrittleMode(cx: &mut JSContext, setting: bool) -> bool);
wrap!(jsapi: pub fn PrepareZoneForGC(cx: &mut JSContext, zone: *mut Zone));
wrap!(jsapi: pub fn PrepareForFullGC(cx: &mut JSContext));
wrap!(jsapi: pub fn PrepareForIncrementalGC(cx: &mut JSContext));
wrap!(jsapi: pub fn IsGCScheduled(cx: &mut JSContext) -> bool);
wrap!(jsapi: pub fn SkipZoneForGC(cx: &mut JSContext, zone: *mut Zone));
...
wrap!(jsapi: pub fn IncrementalGCHasForegroundWork(cx: &mut JSContext) -> bool);
...
wrap!(jsapi: pub fn MinorGcToJSON(cx: &mut JSContext) -> UniqueChars);
wrap!(jsapi: pub fn SetGCSliceCallback(cx: &mut JSContext, callback: GCSliceCallback) -> GCSliceCallback);
wrap!(jsapi: pub fn AddGCNurseryCollectionCallback(cx: &mut JSContext, callback: GCNurseryCollectionCallback, data: *mut ::std::os::raw::c_void) -> bool);
wrap!(jsapi: pub fn RemoveGCNurseryCollectionCallback(cx: &mut JSContext, callback: GCNurseryCollectionCallback, data: *mut ::std::os::raw::c_void));
wrap!(jsapi: pub fn SetDoCycleCollectionCallback(cx: &mut JSContext, callback: DoCycleCollectionCallback) -> DoCycleCollectionCallback);
wrap!(jsapi: pub fn SetCreateGCSliceBudgetCallback(cx: &mut JSContext, cb: CreateSliceBudgetCallback));
wrap!(jsapi: pub fn IsIncrementalGCEnabled(cx: &mut JSContext) -> bool);
wrap!(jsapi: pub fn IsIncrementalGCInProgress(cx: &mut JSContext) -> bool);
wrap!(jsapi: pub fn SetLowMemoryState(cx: &mut JSContext, newState: bool));
wrap!(jsapi: pub fn NotifyGCRootsRemoved(cx: &mut JSContext));
wrap!(jsapi: pub fn SetHostCleanupFinalizationRegistryCallback(cx: &mut JSContext, cb: JSHostCleanupFinalizationRegistryCallback, data: *mut ::std::os::raw::c_void));
wrap!(jsapi: pub fn ClearKeptObjects(cx: &mut JSContext));
wrap!(jsapi: pub fn ReportUncatchableException(cx: &mut JSContext));
...
wrap!(jsapi: pub fn SetPendingExceptionStack(cx: &mut JSContext, exceptionStack: *const ExceptionStack));
wrap!(jsapi: pub fn ExceptionStackOrNull(obj: HandleObject) -> *mut JSObject);
wrap!(jsapi: pub fn CurrentGlobalOrNull(cx: &mut JSContext) -> *mut JSObject);
...
wrap!(jsapi: pub fn SetOutOfMemoryCallback(cx: &mut JSContext, cb: OutOfMemoryCallback, data: *mut ::std::os::raw::c_void));
...
wrap!(jsapi: pub fn GetWellKnownSymbol(cx: &mut JSContext, which: SymbolCode) -> *mut Symbol);
wrap!(jsapi: pub fn IterateRealms(cx: &mut JSContext, data: *mut ::std::os::raw::c_void, realmCallback: IterateRealmCallback));
wrap!(jsapi: pub fn IterateRealmsWithPrincipals(cx: &mut JSContext, principals: *mut JSPrincipals, data: *mut ::std::os::raw::c_void, realmCallback: IterateRealmCallback));
wrap!(jsapi: pub fn IterateRealmsInCompartment(cx: &mut JSContext, compartment: *mut Compartment, data: *mut ::std::os::raw::c_void, realmCallback: IterateRealmCallback));
wrap!(jsapi: pub fn RealmCreationOptionsRef1(cx: &mut JSContext) -> *const RealmCreationOptions);
wrap!(jsapi: pub fn RealmBehaviorsRef1(cx: &mut JSContext) -> *const RealmBehaviors);
...
wrap!(jsapi: pub fn IsAsyncStackCaptureEnabledForRealm(cx: &mut JSContext) -> bool);
...
wrap!(jsapi: pub fn InitConsumeStreamCallback(cx: &mut JSContext, consume: ConsumeStreamCallback, report: ReportStreamErrorCallback));
wrap!(jsapi: pub fn NewStringFromLatin1Buffer(cx: &mut JSContext, buffer: RefPtr<StringBuffer>, length: usize) -> *mut JSString);
wrap!(jsapi: pub fn NewStringFromKnownLiveLatin1Buffer(cx: &mut JSContext, buffer: *mut StringBuffer, length: usize) -> *mut JSString);
wrap!(jsapi: pub fn NewStringFromTwoByteBuffer(cx: &mut JSContext, buffer: RefPtr<StringBuffer>, length: usize) -> *mut JSString);
...
wrap!(jsapi: pub fn GetJSTimers(cx: &mut JSContext) -> JSTimers);
wrap!(jsapi: pub fn NewWeakMapObject(cx: &mut JSContext) -> *mut JSObject);
wrap!(jsapi: pub fn GetWeakMapEntry(cx: &mut JSContext, mapObj: HandleObject, key: HandleValue, val: MutableHandleValue) -> bool);
...
wrap!(jsapi: pub fn PropertySpecNameToPermanentId(cx: &mut JSContext, name: JSPropertySpec_Name, idp: *mut jsid) -> bool);
wrap!(jsapi: pub fn GetScriptedCallerGlobal(cx: &mut JSContext) -> *mut JSObject);
wrap!(jsapi: pub fn HideScriptedCaller(cx: &mut JSContext));
wrap!(jsapi: pub fn UnhideScriptedCaller(cx: &mut JSContext));
...
wrap!(jsapi: pub fn ContextOptionsRef(cx: &mut JSContext) -> *mut ContextOptions);
...
wrap!(jsapi: pub fn IsISOStyleDate(cx: &mut JSContext, str_: *const Latin1Chars) -> bool);
...
wrap!(jsapi: pub fn SystemCompartmentCount(cx: &mut JSContext) -> usize);
wrap!(jsapi: pub fn UserCompartmentCount(cx: &mut JSContext) -> usize);
wrap!(jsapi: pub fn SystemRealmCount(cx: &mut JSContext) -> usize);
wrap!(jsapi: pub fn UserRealmCount(cx: &mut JSContext) -> usize);
...
wrap!(jsapi: pub fn GetRequestedModulesCount(cx: &mut JSContext, moduleRecord: Handle<*mut JSObject>) -> u32);
wrap!(jsapi: pub fn GetRequestedModuleSpecifier(cx: &mut JSContext, moduleRecord: Handle<*mut JSObject>, index: u32) -> *mut JSString);
wrap!(jsapi: pub fn GetRequestedModuleSourcePos(cx: &mut JSContext, moduleRecord: Handle<*mut JSObject>, index: u32, lineNumber: *mut u32, columnNumber: *mut ColumnNumberOneOrigin));
wrap!(jsapi: pub fn GetRequestedModuleType(cx: &mut JSContext, moduleRecord: Handle<*mut JSObject>, index: u32) -> ModuleType);
...
wrap!(jsapi: pub fn GetModuleRequestSpecifier(cx: &mut JSContext, moduleRequestArg: Handle<*mut JSObject>) -> *mut JSString);
wrap!(jsapi: pub fn GetModuleRequestType(cx: &mut JSContext, moduleRequestArg: Handle<*mut JSObject>) -> ModuleType);
...
wrap!(jsapi: pub fn GetModuleForNamespace(cx: &mut JSContext, moduleNamespace: Handle<*mut JSObject>) -> *mut JSObject);
wrap!(jsapi: pub fn GetModuleEnvironment(cx: &mut JSContext, moduleObj: Handle<*mut JSObject>) -> *mut JSObject);
wrap!(jsapi: pub fn GetBuiltinClass(cx: &mut JSContext, obj: Handle<*mut JSObject>, cls: *mut ESClass) -> bool);
wrap!(jsapi: pub fn SetJobQueue(cx: &mut JSContext, queue: *mut JobQueue));
wrap!(jsapi: pub fn SetPromiseRejectionTrackerCallback(cx: &mut JSContext, callback: PromiseRejectionTrackerCallback, data: *mut ::std::os::raw::c_void));
wrap!(jsapi: pub fn JobQueueIsEmpty(cx: &mut JSContext));
wrap!(jsapi: pub fn JobQueueMayNotBeEmpty(cx: &mut JSContext));
...
wrap!(jsapi: pub fn InitDispatchsToEventLoop(cx: &mut JSContext, callback: DispatchToEventLoopCallback, delayedCallback: DelayedDispatchToEventLoopCallback, closure: *mut ::std::os::raw::c_void));
...
wrap!(jsapi: pub fn SetRegExpInput(cx: &mut JSContext, obj: Handle<*mut JSObject>, input: Handle<*mut JSString>) -> bool);
wrap!(jsapi: pub fn ClearRegExpStatics(cx: &mut JSContext, obj: Handle<*mut JSObject>) -> bool);
...
wrap!(jsapi: pub fn ContainsSharedArrayBuffer(cx: &mut JSContext) -> bool);
wrap!(jsapi: pub fn GetWarningReporter(cx: &mut JSContext) -> WarningReporter);
wrap!(jsapi: pub fn SetWarningReporter(cx: &mut JSContext, reporter: WarningReporter) -> WarningReporter);
...
wrap!(jsapi: pub fn InstantiateGlobalStencil(cx: &mut JSContext, options: *const InstantiateOptions, stencil: *mut Stencil, storage: *mut InstantiationStorage) -> *mut JSScript);
wrap!(jsapi: pub fn InstantiateModuleStencil(cx: &mut JSContext, options: *const InstantiateOptions, stencil: *mut Stencil, storage: *mut InstantiationStorage) -> *mut JSObject);
wrap!(jsapi: pub fn DecodeStencil(cx: &mut JSContext, options: *const ReadOnlyDecodeOptions, range: *const TranscodeRange, stencilOut: *mut *mut Stencil) -> TranscodeResult);
wrap!(jsapi: pub fn StartCollectingDelazifications(cx: &mut JSContext, script: Handle<*mut JSScript>, stencil: *mut Stencil, alreadyStarted: *mut bool) -> bool);
wrap!(jsapi: pub fn StartCollectingDelazifications1(cx: &mut JSContext, module: Handle<*mut JSObject>, stencil: *mut Stencil, alreadyStarted: *mut bool) -> bool);
...
wrap!(jsapi: pub fn JS_ReportOutOfMemory(cx: &mut JSContext));
...
wrap!(jsapi: pub fn JS_EncodeStringToLatin1(cx: &mut JSContext, str_: *mut JSString) -> UniqueChars);
wrap!(jsapi: pub fn JS_EncodeStringToUTF8(cx: &mut JSContext, str_: Handle<*mut JSString>) -> UniqueChars);
wrap!(jsapi: pub fn JS_EncodeStringToASCII(cx: &mut JSContext, str_: *mut JSString) -> UniqueChars);
wrap!(jsapi: pub fn JS_DestroyContext(cx: &mut JSContext));
wrap!(jsapi: pub fn JS_GetContextPrivate(cx: &mut JSContext) -> *mut ::std::os::raw::c_void);
wrap!(jsapi: pub fn JS_SetContextPrivate(cx: &mut JSContext, data: *mut ::std::os::raw::c_void));
...
wrap!(jsapi: pub fn JS_SetFutexCanWait(cx: &mut JSContext));
wrap!(jsapi: pub fn JS_AddExtraGCRootsTracer(cx: &mut JSContext, traceOp: JSTraceDataOp, data: *mut ::std::os::raw::c_void) -> bool);
wrap!(jsapi: pub fn JS_RemoveExtraGCRootsTracer(cx: &mut JSContext, traceOp: JSTraceDataOp, data: *mut ::std::os::raw::c_void));
wrap!(jsapi: pub fn JS_GC(cx: &mut JSContext, reason: GCReason));
wrap!(jsapi: pub fn JS_MaybeGC(cx: &mut JSContext));
wrap!(jsapi: pub fn JS_SetGCCallback(cx: &mut JSContext, cb: JSGCCallback, data: *mut ::std::os::raw::c_void));
wrap!(jsapi: pub fn JS_SetObjectsTenuredCallback(cx: &mut JSContext, cb: JSObjectsTenuredCallback, data: *mut ::std::os::raw::c_void));
wrap!(jsapi: pub fn JS_AddFinalizeCallback(cx: &mut JSContext, cb: JSFinalizeCallback, data: *mut ::std::os::raw::c_void) -> bool);
wrap!(jsapi: pub fn JS_RemoveFinalizeCallback(cx: &mut JSContext, cb: JSFinalizeCallback));
wrap!(jsapi: pub fn JS_AddWeakPointerZonesCallback(cx: &mut JSContext, cb: JSWeakPointerZonesCallback, data: *mut ::std::os::raw::c_void) -> bool);
wrap!(jsapi: pub fn JS_RemoveWeakPointerZonesCallback(cx: &mut JSContext, cb: JSWeakPointerZonesCallback));
wrap!(jsapi: pub fn JS_AddWeakPointerCompartmentCallback(cx: &mut JSContext, cb: JSWeakPointerCompartmentCallback, data: *mut ::std::os::raw::c_void) -> bool);
wrap!(jsapi: pub fn JS_RemoveWeakPointerCompartmentCallback(cx: &mut JSContext, cb: JSWeakPointerCompartmentCallback));
...
wrap!(jsapi: pub fn JS_IsExceptionPending(cx: &mut JSContext) -> bool);
wrap!(jsapi: pub fn JS_IsThrowingOutOfMemory(cx: &mut JSContext) -> bool);
...
wrap!(jsapi: pub fn JS_ClearPendingException(cx: &mut JSContext));
...
wrap!(jsapi: pub fn JS_AddInterruptCallback(cx: &mut JSContext, callback: JSInterruptCallback) -> bool);
wrap!(jsapi: pub fn JS_DisableInterruptCallback(cx: &mut JSContext) -> bool);
wrap!(jsapi: pub fn JS_ResetInterruptCallback(cx: &mut JSContext, enable: bool));
wrap!(jsapi: pub fn JS_RequestInterruptCallback(cx: &mut JSContext));
wrap!(jsapi: pub fn JS_RequestInterruptCallbackCanWait(cx: &mut JSContext));
wrap!(jsapi: pub fn JS_malloc(cx: &mut JSContext, nbytes: usize) -> *mut ::std::os::raw::c_void);
wrap!(jsapi: pub fn JS_realloc(cx: &mut JSContext, p: *mut ::std::os::raw::c_void, oldBytes: usize, newBytes: usize) -> *mut ::std::os::raw::c_void);
wrap!(jsapi: pub fn JS_free(cx: &mut JSContext, p: *mut ::std::os::raw::c_void));
wrap!(jsapi: pub fn JS_string_malloc(cx: &mut JSContext, nbytes: usize) -> *mut ::std::os::raw::c_void);
wrap!(jsapi: pub fn JS_string_realloc(cx: &mut JSContext, p: *mut ::std::os::raw::c_void, oldBytes: usize, newBytes: usize) -> *mut ::std::os::raw::c_void);
wrap!(jsapi: pub fn JS_string_free(cx: &mut JSContext, p: *mut ::std::os::raw::c_void));
wrap!(jsapi: pub fn JS_DropPrincipals(cx: &mut JSContext, principals: *mut JSPrincipals));
wrap!(jsapi: pub fn JS_SetSecurityCallbacks(cx: &mut JSContext, callbacks: *const JSSecurityCallbacks));
wrap!(jsapi: pub fn JS_GetSecurityCallbacks(cx: &mut JSContext) -> *const JSSecurityCallbacks);
wrap!(jsapi: pub fn JS_SetTrustedPrincipals(cx: &mut JSContext, prin: *mut JSPrincipals));
wrap!(jsapi: pub fn JS_InitDestroyPrincipalsCallback(cx: &mut JSContext, destroyPrincipals: JSDestroyPrincipalsOp));
wrap!(jsapi: pub fn JS_InitReadPrincipalsCallback(cx: &mut JSContext, read: JSReadPrincipalsOp));
...
wrap!(jsapi: pub fn JS_SetNativeStackQuota(cx: &mut JSContext, systemCodeStackSize: NativeStackSize, trustedScriptStackSize: NativeStackSize, untrustedScriptStackSize: NativeStackSize));
wrap!(jsapi: pub fn JS_GetEmptyString(cx: &mut JSContext) -> *mut JSString);
...
wrap!(jsapi: pub fn JS_AtomizeStringN(cx: &mut JSContext, s: *const ::std::os::raw::c_char, length: usize) -> *mut JSString);
wrap!(jsapi: pub fn JS_AtomizeString(cx: &mut JSContext, s: *const ::std::os::raw::c_char) -> *mut JSString);
wrap!(jsapi: pub fn JS_AtomizeAndPinStringN(cx: &mut JSContext, s: *const ::std::os::raw::c_char, length: usize) -> *mut JSString);
wrap!(jsapi: pub fn JS_AtomizeAndPinString(cx: &mut JSContext, s: *const ::std::os::raw::c_char) -> *mut JSString);
...
wrap!(jsapi: pub fn JS_AtomizeUCStringN(cx: &mut JSContext, s: *const u16, length: usize) -> *mut JSString);
wrap!(jsapi: pub fn JS_AtomizeUCString(cx: &mut JSContext, s: *const u16) -> *mut JSString);
wrap!(jsapi: pub fn JS_CompareStrings(cx: &mut JSContext, str1: *mut JSString, str2: *mut JSString, result: *mut i32) -> bool);
wrap!(jsapi: pub fn JS_StringEqualsAscii(cx: &mut JSContext, str_: *mut JSString, asciiBytes: *const ::std::os::raw::c_char, match_: *mut bool) -> bool);
wrap!(jsapi: pub fn JS_StringEqualsAscii1(cx: &mut JSContext, str_: *mut JSString, asciiBytes: *const ::std::os::raw::c_char, length: usize, match_: *mut bool) -> bool);
wrap!(jsapi: pub fn JS_PutEscapedString(cx: &mut JSContext, buffer: *mut ::std::os::raw::c_char, size: usize, str_: *mut JSString, quote: ::std::os::raw::c_char) -> usize);
...
wrap!(jsapi: pub fn JS_GetStringCharAt(cx: &mut JSContext, str_: *mut JSString, index: usize, res: *mut u16) -> bool);
wrap!(jsapi: pub fn JS_CopyStringChars(cx: &mut JSContext, dest: *const Range<u16>, str_: *mut JSString) -> bool);
wrap!(jsapi: pub fn JS_CopyStringCharsZ(cx: &mut JSContext, str_: *mut JSString) -> UniqueTwoByteChars);
wrap!(jsapi: pub fn JS_EnsureLinearString(cx: &mut JSContext, str_: *mut JSString) -> *mut JSLinearString);
...
wrap!(jsapi: pub fn JS_DecodeBytes(cx: &mut JSContext, src: *const ::std::os::raw::c_char, srclen: usize, dst: *mut u16, dstlenp: *mut usize) -> bool);
wrap!(jsapi: pub fn JS_GetStringEncodingLength(cx: &mut JSContext, str_: *mut JSString) -> usize);
wrap!(jsapi: pub fn JS_EncodeStringToBuffer(cx: &mut JSContext, str_: *mut JSString, buffer: *mut ::std::os::raw::c_char, length: usize) -> bool);
wrap!(jsapi: pub fn JS_SetDestroyZoneCallback(cx: &mut JSContext, callback: JSDestroyZoneCallback));
wrap!(jsapi: pub fn JS_SetDestroyCompartmentCallback(cx: &mut JSContext, callback: JSDestroyCompartmentCallback));
wrap!(jsapi: pub fn JS_SetSizeOfIncludingThisCompartmentCallback(cx: &mut JSContext, callback: JSSizeOfIncludingThisCompartmentCallback));
wrap!(jsapi: pub fn JS_RefreshCrossCompartmentWrappers(cx: &mut JSContext, obj: Handle<*mut JSObject>) -> bool);
wrap!(jsapi: pub fn JS_MarkCrossZoneId(cx: &mut JSContext, id: jsid));
wrap!(jsapi: pub fn JS_MarkCrossZoneIdValue(cx: &mut JSContext, value: *const Value));
wrap!(jsapi: pub fn JS_StringHasBeenPinned(cx: &mut JSContext, str_: *mut JSString) -> bool);
...
wrap!(jsapi: pub fn JS_SetWrapObjectCallbacks(cx: &mut JSContext, callbacks: *const JSWrapObjectCallbacks));
...
wrap!(jsapi: pub fn JS_GetFunctionId(cx: &mut JSContext, fun: Handle<*mut JSFunction>, name: MutableHandle<*mut JSString>) -> bool);
wrap!(jsapi: pub fn JS_GetFunctionDisplayId(cx: &mut JSContext, fun: Handle<*mut JSFunction>, name: MutableHandle<*mut JSString>) -> bool);
wrap!(jsapi: pub fn JS_GetFunctionLength(cx: &mut JSContext, fun: HandleFunction, length: *mut u16) -> bool);
wrap!(jsapi: pub fn JS_GetScriptBaseLineNumber(cx: &mut JSContext, script: *mut JSScript) -> ::std::os::raw::c_uint);
...
wrap!(jsapi: pub fn JS_AbortIfWrongThread(cx: &mut JSContext));
wrap!(jsapi: pub fn JS_NewObjectForConstructor(cx: &mut JSContext, clasp: *const JSClass, args: *const CallArgs) -> *mut JSObject);
wrap!(jsapi: pub fn JS_SetOffthreadBaselineCompilationEnabled(cx: &mut JSContext, enabled: bool));
wrap!(jsapi: pub fn JS_SetOffthreadIonCompilationEnabled(cx: &mut JSContext, enabled: bool));
wrap!(jsapi: pub fn JS_SetGlobalJitCompilerOption(cx: &mut JSContext, opt: JSJitCompilerOption, value: u32));
wrap!(jsapi: pub fn JS_GetGlobalJitCompilerOption(cx: &mut JSContext, opt: JSJitCompilerOption, valueOut: *mut u32) -> bool);
...
wrap!(jsapi: pub fn JS_SetGrayGCRootsTracer(cx: &mut JSContext, traceOp: JSGrayRootsTracer, data: *mut ::std::os::raw::c_void));
