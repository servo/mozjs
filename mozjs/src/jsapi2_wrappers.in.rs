...
wrap!(jsapi: pub fn RegisterContextProfilerMarkers(cx: &JSContext, eventMarker: ::std::option::Option<unsafe extern "C" fn(arg1: MarkerCategory, arg2: *const ::std::os::raw::c_char, arg3: *const ::std::os::raw::c_char)>, intervalMarker: ::std::option::Option<unsafe extern "C" fn(arg1: MarkerCategory, arg2: *const ::std::os::raw::c_char, arg3: TimeStamp, arg4: *const ::std::os::raw::c_char)>, flowMarker: ::std::option::Option<unsafe extern "C" fn(arg1: MarkerCategory, arg2: *const ::std::os::raw::c_char, arg3: u64)>, terminatingFlowMarker: ::std::option::Option<unsafe extern "C" fn(arg1: MarkerCategory, arg2: *const ::std::os::raw::c_char, arg3: u64)>));
...
wrap!(jsapi: pub fn GetSetObjectKeys(cx: &mut JSContext, obj: HandleObject, keys: u8) -> bool);
wrap!(jsapi: pub fn GetMapObjectKeysAndValuesInterleaved(cx: &mut JSContext, obj: HandleObject, entries: u8) -> bool);
...
wrap!(jsapi: pub fn CommitPendingWrapperPreservations(cx: &mut JSContext));
...
wrap!(jsapi: pub fn MapGetOrInsert(cx: &mut JSContext, obj: HandleObject, key: HandleValue, val: HandleValue, rval: MutableHandleValue) -> bool);
...
wrap!(jsapi: pub fn SetMeasuringExecutionTimeEnabled(cx: &JSContext, value: bool));
...
wrap!(jsapi: pub fn AddSizeOfTab(cx: &JSContext, zone: *mut Zone, mallocSizeOf: MallocSizeOf, opv: *mut ObjectPrivateVisitor, sizes: *mut TabSizes, nogc: *const AutoRequireNoGC) -> bool);
...
wrap!(jsapi: pub fn LoadRequestedModules(cx: &mut JSContext, module: Handle<*mut JSObject>, hostDefined: Handle<Value>, resolved: LoadModuleResolvedCallback, rejected: LoadModuleRejectedCallback) -> bool);
wrap!(jsapi: pub fn LoadRequestedModules1(cx: &mut JSContext, module: Handle<*mut JSObject>, hostDefined: Handle<Value>, promiseOut: MutableHandle<*mut JSObject>) -> bool);
wrap!(jsapi: pub fn FinishLoadingImportedModule(cx: &mut JSContext, referrer: Handle<*mut JSScript>, moduleRequest: Handle<*mut JSObject>, payload: Handle<Value>, result: Handle<*mut JSObject>, usePromise: bool) -> bool);
wrap!(jsapi: pub fn FinishLoadingImportedModuleFailed(cx: &mut JSContext, payload: Handle<Value>, error: Handle<Value>) -> bool);
wrap!(jsapi: pub fn FinishLoadingImportedModuleFailedWithPendingException(cx: &mut JSContext, payload: Handle<Value>) -> bool);
wrap!(jsapi: pub fn FinishLoadingDynamicImportedModule(cx: &mut JSContext, referrer: Handle<*mut JSScript>, moduleRequest: Handle<*mut JSObject>, payload: Handle<Value>, result: Handle<*mut JSObject>) -> bool);
...
wrap!(jsapi: pub fn CreateDefaultExportSyntheticModule(cx: &mut JSContext, defaultExport: Handle<Value>) -> *mut JSObject);
wrap!(jsapi: pub fn CompileWasmModule(cx: &mut JSContext, options: *const ReadOnlyCompileOptions, srcBuf: *mut u8) -> *mut JSObject);
wrap!(jsapi: pub fn CompileWasmModuleAsSource(cx: &mut JSContext, options: *const ReadOnlyCompileOptions, srcBuf: *mut u8) -> *mut JSObject);
...
wrap!(jsapi: pub fn ModuleRequestIsSourcePhase(cx: &JSContext, moduleRequestArg: Handle<*mut JSObject>) -> bool);
...
wrap!(jsapi: pub fn MaybeGetPromiseAllocationSiteFromPossiblyWrappedPromise(maybePromise: HandleObject) -> *mut JSObject);
...
wrap!(jsapi: pub fn InitAsyncTaskCallbacks(cx: &JSContext, dispatchCallback: DispatchToEventLoopCallback, delayedDispatchCallback: DelayedDispatchToEventLoopCallback, asyncTaskStartedCallback: AsyncTaskStartedCallback, asyncTaskFinishedCallback: AsyncTaskFinishedCallback, closure: *mut ::std::os::raw::c_void));
wrap!(jsapi: pub fn CancelAsyncTasks(cx: &JSContext));
...
wrap!(jsapi: pub fn EnqueueDebugMicroTask(cx: &JSContext, entry: *const GenericMicroTask) -> bool);
wrap!(jsapi: pub fn PrependMicroTask(cx: &JSContext, entry: *const GenericMicroTask) -> bool);
wrap!(jsapi: pub fn DequeueNextDebuggerMicroTask(cx: &JSContext) -> GenericMicroTask);
wrap!(jsapi: pub fn DequeueNextRegularMicroTask(cx: &JSContext) -> GenericMicroTask);
wrap!(jsapi: pub fn PeekNextMicroTask(cx: &JSContext) -> GenericMicroTask);
wrap!(jsapi: pub fn HasAnyMicroTasks(cx: &JSContext) -> bool);
wrap!(jsapi: pub fn HasDebuggerMicroTasks(cx: &JSContext) -> bool);
wrap!(jsapi: pub fn HasRegularMicroTasks(cx: &JSContext) -> bool);
wrap!(jsapi: pub fn GetRegularMicroTaskCount(cx: &JSContext) -> usize);
wrap!(jsapi: pub fn SaveMicroTaskQueue(cx: &JSContext) -> u8);
wrap!(jsapi: pub fn RestoreMicroTaskQueue(cx: &JSContext, savedQueue: u8));
...
wrap!(jsapi: pub fn JS_GetLastOOMStackTrace(cx: &JSContext) -> *const ::std::os::raw::c_char);
...
wrap!(jsapi: pub fn JS_ErrorFromException(cx: &JSContext, obj: HandleObject, errorReport: *mut BorrowedErrorReport) -> bool);
...
wrap!(jsapi: pub fn JS_IterateCompartments(cx: &JSContext, data: *mut ::std::os::raw::c_void, compartmentCallback: JSIterateCompartmentCallback));
wrap!(jsapi: pub fn JS_IterateCompartmentsInZone(cx: &JSContext, zone: *mut Zone, data: *mut ::std::os::raw::c_void, compartmentCallback: JSIterateCompartmentCallback));
