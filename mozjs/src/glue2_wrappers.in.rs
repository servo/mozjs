...
wrap!(glue: pub fn PendingExceptionStackInfo(cx: &mut JSContext, message_buffer: *mut ::std::os::raw::c_char, filename_buffer: *mut ::std::os::raw::c_char, buflen: usize, line: *mut u32, col: *mut u32, dest: MutableHandleValue) -> bool);
