...
wrap!(glue: pub fn StackGCVectorValueLength(vec: *const Handle<StackGCVector<Value, TempAllocPolicy>>) -> u32);
wrap!(glue: pub fn StackGCVectorStringLength(vec: *const Handle<StackGCVector<*mut JSString, TempAllocPolicy>>) -> u32);
