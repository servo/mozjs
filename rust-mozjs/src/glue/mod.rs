...
pub struct JobQueueTraps {
    pub getIncumbentGlobal: Option<unsafe extern "C" fn(queue: *const c_void, cx: *mut JSContext) -> *mut JSObject>,
    pub enqueuePromiseJob: Option<unsafe extern "C" fn(queue: *const c_void, cx: *mut JSContext, promise: HandleObject, job: HandleObject, allocationSite: HandleObject, incumbentGlobal: HandleObject) -> bool>,
...
pub struct ReadableStreamUnderlyingSourceTraps {
    pub requestData: Option<unsafe extern "C" fn(source: *const c_void, cx: *mut JSContext, stream: HandleObject, desiredSize: usize)>,
    pub writeIntoReadRequestBuffer: Option<unsafe extern "C" fn(source: *const c_void, cx: *mut JSContext, stream: HandleObject, chunk: HandleObject, length: usize, bytesWritten: *mut usize)>,
    pub cancel: Option<unsafe extern "C" fn(source: *const c_void, cx: *mut JSContext, stream: HandleObject, reason: HandleValue, resolve_to: *mut Value)>,
    pub onClosed: Option<unsafe extern "C" fn(source: *const c_void, cx: *mut JSContext, stream: HandleObject)>,
    pub onErrored: Option<unsafe extern "C" fn(source: *const c_void, cx: *mut JSContext, stream: HandleObject, reason: HandleValue)>,
...
pub struct JSExternalStringCallbacksTraps {
    ...
    pub sizeOfBuffer: Option<unsafe extern "C" fn(*const c_void, *const u16, MallocSizeOf) -> usize>,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ProxyTraps {
    pub enter: Option<unsafe extern "C" fn(cx: *mut JSContext, proxy: HandleObject, id: HandleId, action: Action, bp: *mut bool) -> bool>,
    ...
    pub nativeCall: Option<unsafe extern "C" fn(cx: *mut JSContext, test: IsAcceptableThis, _impl: NativeImpl, args: CallArgs) -> bool>,
    pub objectClassIs: ::std::option::Option<unsafe extern "C" fn(obj: HandleObject, classValue: ESClass, cx: *mut JSContext) -> bool>,
...
impl Default for ForwardingProxyHandler {
    fn default() -> ForwardingProxyHandler {
        ForwardingProxyHandler { mTraps: ProxyTraps::default(), mExtra: ptr::null() }
    }
}
...
pub struct JSPrincipalsCallbacks {
    pub write: Option<unsafe extern "C" fn(*mut JSPrincipals, *mut JSContext, *mut JSStructuredCloneWriter) -> bool>,
    pub isSystemOrAddonPrincipal: Option<unsafe extern "C" fn(*mut JSPrincipals) -> bool>,
}

extern "C" {
    pub fn CreateRustJSPrincipals(callbacks: *const JSPrincipalsCallbacks, private: *mut c_void) -> *mut JSPrincipals;
    ...
    pub fn InvokeGetOwnPropertyDescriptor(handler: *const c_void, cx: *mut JSContext, proxy: HandleObject, id: HandleId, desc: MutableHandle<PropertyDescriptor>, isNone: *mut bool) -> bool;
    pub fn InvokeHasOwn(handler: *const c_void, cx: *mut JSContext, proxy: HandleObject, id: HandleId, bp: *mut bool) -> bool;
    ...
    pub fn CallJitGetterOp(info: *const JSJitInfo, cx: *mut JSContext, thisObj: HandleObject, specializedThis: *mut c_void, argc: u32, vp: *mut Value) -> bool;
    pub fn CallJitSetterOp(info: *const JSJitInfo, cx: *mut JSContext, thisObj: HandleObject, specializedThis: *mut c_void, argc: u32, vp: *mut Value) -> bool;
    pub fn CallJitMethodOp(info: *const JSJitInfo, cx: *mut JSContext, thisObj: HandleObject, specializedThis: *mut c_void, argc: u32, vp: *mut Value) -> bool;
    ...
    pub fn NewCompileOptions(aCx: *mut JSContext, aFile: *const c_char, aLine: u32) -> *mut ReadOnlyCompileOptions;
    pub fn DeleteCompileOptions(aOpts: *mut ReadOnlyCompileOptions);
    pub fn NewProxyObject(aCx: *mut JSContext, aHandler: *const c_void, aPriv: HandleValue, proto: *mut JSObject, classp: *const JSClass, aLazyProto: bool) -> *mut JSObject;
    pub fn WrapperNew(aCx: *mut JSContext, aObj: HandleObject, aHandler: *const c_void, aClass: *const JSClass, aSingleton: bool) -> *mut JSObject;

    pub fn NewWindowProxy(aCx: *mut JSContext, aObj: HandleObject, aHandler: *const c_void) -> *mut JSObject;
    ...
    pub fn RUST_INTERNED_STRING_TO_JSID(cx: *mut JSContext, str: *mut JSString, id: MutableHandleId);
    pub fn RUST_js_GetErrorMessage(userRef: *mut c_void, errorNumber: u32) -> *const JSErrorFormatString;
    ...
    pub fn AppendToRootedObjectVector(v: *mut PersistentRootedObjectVector, obj: *mut JSObject) -> bool;
    ...
    pub fn CallObjectTracer(trc: *mut JSTracer, objp: *mut Heap<*mut JSObject>, name: *const c_char);
    pub fn CallStringTracer(trc: *mut JSTracer, strp: *mut Heap<*mut JSString>, name: *const c_char);
    pub fn CallScriptTracer(trc: *mut JSTracer, scriptp: *mut Heap<*mut JSScript>, name: *const c_char);
    pub fn CallFunctionTracer(trc: *mut JSTracer, funp: *mut Heap<*mut JSFunction>, name: *const c_char);
    pub fn CallUnbarrieredObjectTracer(trc: *mut JSTracer, objp: *mut *mut JSObject, name: *const c_char);
    ...
    pub fn GetInt8ArrayLengthAndData(obj: *mut JSObject, length: *mut usize, isSharedMemory: *mut bool, data: *mut *mut i8);
    pub fn GetUint8ArrayLengthAndData(obj: *mut JSObject, length: *mut usize, isSharedMemory: *mut bool, data: *mut *mut u8);
    pub fn GetUint8ClampedArrayLengthAndData(obj: *mut JSObject, length: *mut usize, isSharedMemory: *mut bool, data: *mut *mut u8);
    pub fn GetInt16ArrayLengthAndData(obj: *mut JSObject, length: *mut usize, isSharedMemory: *mut bool, data: *mut *mut i16);
    pub fn GetUint16ArrayLengthAndData(obj: *mut JSObject, length: *mut usize, isSharedMemory: *mut bool, data: *mut *mut u16);
    pub fn GetInt32ArrayLengthAndData(obj: *mut JSObject, length: *mut usize, isSharedMemory: *mut bool, data: *mut *mut i32);
    pub fn GetUint32ArrayLengthAndData(obj: *mut JSObject, length: *mut usize, isSharedMemory: *mut bool, data: *mut *mut u32);
    pub fn GetFloat32ArrayLengthAndData(obj: *mut JSObject, length: *mut usize, isSharedMemory: *mut bool, data: *mut *mut f32);
    pub fn GetFloat64ArrayLengthAndData(obj: *mut JSObject, length: *mut usize, isSharedMemory: *mut bool, data: *mut *mut f64);

    pub fn NewJSAutoStructuredCloneBuffer(scope: StructuredCloneScope, callbacks: *const JSStructuredCloneCallbacks) -> *mut JSAutoStructuredCloneBuffer;
    ...
    pub fn CreateReadableStreamUnderlyingSource(traps: *const ReadableStreamUnderlyingSourceTraps, source: *const c_void) -> *mut ReadableStreamUnderlyingSource;
    pub fn DeleteReadableStreamUnderlyingSource(source: *mut ReadableStreamUnderlyingSource);
    pub fn CreateJSExternalStringCallbacks(traps: *const JSExternalStringCallbacksTraps, privateData: *const c_void) -> *mut JSExternalStringCallbacks;
    pub fn DeleteJSExternalStringCallbacks(callbacks: *mut JSExternalStringCallbacks);
    pub fn DispatchableRun(cx: *mut JSContext, ptr: *mut Dispatchable, mb: Dispatchable_MaybeShuttingDown);
    pub fn StreamConsumerConsumeChunk(sc: *mut StreamConsumer, begin: *const u8, length: usize) -> bool;
    ...
    pub fn StreamConsumerNoteResponseURLs(sc: *mut StreamConsumer, maybeUrl: *const c_char, maybeSourceMapUrl: *const c_char);
    ...
    pub fn FinishOffThreadStencil(cx: *mut JSContext, token: *mut OffThreadToken, storage: *mut InstantiationStorage, out: *mut already_AddRefed<CompilationStencil>);
}
