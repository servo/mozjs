...
# merge dir. Copy it into the localization root ($1) so it ships in the locale's
# omnijar, reachable at resource://gre/localization/<locale>/coverage.json. This
# is a no-op for en-US, which has no merge dir.
