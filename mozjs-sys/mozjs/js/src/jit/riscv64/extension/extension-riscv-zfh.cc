...
void AssemblerRISCVZfh::fcvt_h_wu(FPURegister rd, Register rs1,
                                  FPURoundingMode frm) {
  GenInstrALUFP_rr(0b1101010, frm, rd, rs1, Register::FromCode(1));
}
...
void AssemblerRISCVZfh::fcvt_wu_h(Register rd, FPURegister rs1,
                                  FPURoundingMode frm) {
  GenInstrALUFP_rr(0b1100010, frm, rd, rs1, Register::FromCode(1));
}
...
void AssemblerRISCVZfh::fcvt_h_d(FPURegister rd, FPURegister rs1,
                                 FPURoundingMode frm) {
  GenInstrALUFP_rr(0b0100010, frm, rd, rs1, Register::FromCode(1));
}
void AssemblerRISCVZfh::fcvt_d_h(FPURegister rd, FPURegister rs1,
                                 FPURoundingMode frm) {
  GenInstrALUFP_rr(0b0100001, frm, rd, rs1, Register::FromCode(2));
}
...
void AssemblerRISCVZfh::fcvt_s_h(FPURegister rd, FPURegister rs1,
                                 FPURoundingMode frm) {
  GenInstrALUFP_rr(0b0100000, frm, rd, rs1, Register::FromCode(2));
}
...
void AssemblerRISCVZfh::fcvt_l_h(Register rd, FPURegister rs1,
                                 FPURoundingMode frm) {
  GenInstrALUFP_rr(0b1100010, frm, rd, rs1, Register::FromCode(2));
}

void AssemblerRISCVZfh::fcvt_lu_h(Register rd, FPURegister rs1,
                                  FPURoundingMode frm) {
  GenInstrALUFP_rr(0b1100010, frm, rd, rs1, Register::FromCode(3));
}

void AssemblerRISCVZfh::fcvt_h_l(FPURegister rd, Register rs1,
                                 FPURoundingMode frm) {
  GenInstrALUFP_rr(0b1101010, frm, rd, rs1, Register::FromCode(2));
}

void AssemblerRISCVZfh::fcvt_h_lu(FPURegister rd, Register rs1,
                                  FPURoundingMode frm) {
  GenInstrALUFP_rr(0b1101010, frm, rd, rs1, Register::FromCode(3));
}
