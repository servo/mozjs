...
// Load configuration from config.json, which should have been generated by
// either mach_commands.py or testlib.py. Relevant configuration:
//
//   'source': the location of the source directory, to make relative pathnames.
//
//   'sixgill_bin': path to find xdbfind, defaults to searching $PATH.

var config = JSON.parse(os.file.readFile("config.json"))
var sourceRoot = config["source"]
...
{
    const xdbfind = ("sixgill_bin" in config) ? config.sixgill_bin + "/xdbfind" : "xdbfind";
