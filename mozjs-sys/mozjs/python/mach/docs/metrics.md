<!-- AUTOGENERATED BY glean_parser v19.0.0. DO NOT EDIT. -->
...
| mach.moz_automation |[boolean](https://mozilla.github.io/glean/book/user/metrics/boolean.html) |True if this command is being run on Mozilla Automation/CI |[Bug 1894154](https://bugzilla.mozilla.org/show_bug.cgi?id=1894154)||never | |
...
| mach.system.crowdstrike_running |[boolean](https://mozilla.github.io/glean/book/user/metrics/boolean.html) |True if CrowdStrike security software is running. |[Bug 1982531](https://bugzilla.mozilla.org/show_bug.cgi?id=1982531)||never | |
...
| mach.system.fleet_running |[boolean](https://mozilla.github.io/glean/book/user/metrics/boolean.html) |True if FleetDM endpoint management tool is running. |[Bug 1982531](https://bugzilla.mozilla.org/show_bug.cgi?id=1982531)||never | |
...
| mozbuild.tier_artifact_duration |[timespan](https://mozilla.github.io/glean/book/user/metrics/timespan.html) |How long it took for the artifact tier of the build to complete. |[Bug 1894153](https://bugzilla.mozilla.org/show_bug.cgi?id=1894153)||never | |
| mozbuild.tier_compile_duration |[timespan](https://mozilla.github.io/glean/book/user/metrics/timespan.html) |How long it took for the compile tier of the build to complete. |[Bug 1894153](https://bugzilla.mozilla.org/show_bug.cgi?id=1894153)||never | |
| mozbuild.tier_configure_duration |[timespan](https://mozilla.github.io/glean/book/user/metrics/timespan.html) |How long it took for the configure tier of the build to complete. |[Bug 1894153](https://bugzilla.mozilla.org/show_bug.cgi?id=1894153)||never | |
| mozbuild.tier_export_duration |[timespan](https://mozilla.github.io/glean/book/user/metrics/timespan.html) |How long it took for the export tier of the build to complete. |[Bug 1894153](https://bugzilla.mozilla.org/show_bug.cgi?id=1894153)||never | |
| mozbuild.tier_libs_duration |[timespan](https://mozilla.github.io/glean/book/user/metrics/timespan.html) |How long it took for the libs tier of the build to complete. |[Bug 1894153](https://bugzilla.mozilla.org/show_bug.cgi?id=1894153)||never | |
| mozbuild.tier_misc_duration |[timespan](https://mozilla.github.io/glean/book/user/metrics/timespan.html) |How long it took for the misc tier of the build to complete. |[Bug 1894153](https://bugzilla.mozilla.org/show_bug.cgi?id=1894153)||never | |
| mozbuild.tier_pre_export_duration |[timespan](https://mozilla.github.io/glean/book/user/metrics/timespan.html) |How long it took for the pre-export tier of the build to complete. |[Bug 1894153](https://bugzilla.mozilla.org/show_bug.cgi?id=1894153)||never | |
| mozbuild.tier_tools_duration |[timespan](https://mozilla.github.io/glean/book/user/metrics/timespan.html) |How long it took for the tools tier of the build to complete. |[Bug 1894153](https://bugzilla.mozilla.org/show_bug.cgi?id=1894153)||never | |
