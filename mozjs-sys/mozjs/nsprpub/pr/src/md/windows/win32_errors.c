...
void _MD_unix_readdir_error(PRInt32 err) { _MD_win32_map_default_error(err); }
...
void _MD_win32_map_stat_error(PRInt32 err) { _MD_win32_map_default_errno(err); }
...
void _MD_win32_map_read_error(PRInt32 err) { _MD_win32_map_default_error(err); }
...
void _MD_win32_map_recv_error(PRInt32 err) { _MD_win32_map_default_error(err); }
...
void _MD_win32_map_open_error(PRInt32 err) { _MD_win32_map_default_error(err); }
