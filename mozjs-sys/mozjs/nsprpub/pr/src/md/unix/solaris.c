...
void _MD_SolarisInit() { _PR_UnixInit(); }

void _MD_SET_PRIORITY(_MDThread* thread, PRThreadPriority newPri) { return; }
...
int _pr_solx86_clock_gettime(clockid_t clock_id, struct timespec* tp) {
  struct timeval tv;
