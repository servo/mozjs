 ...
 *used by the regress tool parsing routine.
 ** 04-June-97 AGarcia removed the Test_Result function. Regress tool has been
 *updated to recognize the return code from tha main program.
 */
...
static void TestI(void) {
  ...
  static char* precs[] = {
      "", "3", "5", "43", "7.3", "7.5", "7.11", "7.43",
  };
  static char* formats[] = {"d", "o", "x", "u", "hd", "ho", "hx", "hu"};
  int f, s, n, p;
  char fmt[20];
