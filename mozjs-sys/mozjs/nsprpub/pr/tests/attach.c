...
** Name: attach.c
**
** Description: Platform-specific code to create a native thread. The native
*thread will
**                            repeatedly call PR_AttachThread and
*PR_DetachThread. The
**                            primordial thread waits for this new thread to
*finish.
**
