...
// FIXME
#define SERVO_MOZJS_MALLOC_PREFIX mi_
#ifndef SERVO_MOZJS_MALLOC_PREFIX
#error "Embedder must define SERVO_MOZJS_MALLOC_PREFIX for custom allocator builds"
#endif /* SERVO_MOZJS_MALLOC_PREFIX */
...
#define MALLOC_DECL(name, return_type, ...)                                \
  static inline return_type name(ARGS_HELPER(TYPED_ARGS, ##__VA_ARGS__)) { \
    return :: MOZ_EMBED_CONCAT1(SERVO_MOZJS_MALLOC_PREFIX, name)(ARGS_HELPER(ARGS, ##__VA_ARGS__));                       \
  }
